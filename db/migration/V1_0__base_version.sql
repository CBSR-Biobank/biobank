...
INSERT INTO `csm_user` VALUES (1,'administrator',0,'Administrator','NoName',NULL,NULL,NULL,NULL,'zJPWCwDeSgG8j2uyHEABIQ==',NULL,NULL,NULL,'2009-07-22',NULL),(2,'bbadmin',0,'Biobank Administrator','NoName',NULL,NULL,NULL,NULL,'7Bg9siN5e7M=',NULL,NULL,NULL,'2009-07-22',NULL),(27,'testuser',0,'testuser','testuser',NULL,NULL,NULL,NULL,'orDBlaojDQE=',NULL,NULL,NULL,'2012-11-21',NULL);
...
INSERT INTO `csm_user_group_role_pg` VALUES (222,27,NULL,8,1,'2012-11-21');
...
CREATE TABLE `origin_info` (
  ...
  CONSTRAINT `FKE92E7A274D7A8883` FOREIGN KEY (`RECEIVER_SITE_ID`) REFERENCES `center` (`ID`),
...
-- Dump completed on 2012-11-21 16:56:27
