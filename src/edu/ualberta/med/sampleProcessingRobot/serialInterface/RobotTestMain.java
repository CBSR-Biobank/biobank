...
public class RobotTestMain {
    ...
    public static void main(String[] args) {
        ...
        // Read barcode
        /*
         * try{ barcode = robot.scanSourceTubeBarcode(); } catch(RobotException
         * cbsre) { System.out.println(cbsre); done(robot); System.exit(1); }
         * if(barcode == "") {
         * System.out.println("Couldn't read source tube barcode"); done(robot);
         * System.exit(1); }
         */
        // Get fluid level
        try {
