...
public class RobotException extends Exception {
     ...
     * by the X-SEL controller should not be changed unless they are changed on
    ...
    private static final String[] robotErrors = {
        ...
        "Error gripping the source tube cap", "Error with a pipetter tip",
        "Error - no source tube", "Error - invalid source tube number",
        "Error gripping source tube", "Error communicating with the pipetter",
