...
public class RobotInterface {
	 ...
	 * improves accuracy.
	 * The pipetter also has a limited range, so increasing this too far and
	 * requesting 1mL aspirations may result in less liquid being aspirated
	 * than expected.
	 */
	...
	/**
	 * COM port name to try and connect to the X-SEL serial interface on.
	 * This is to connect to the COM2 port on the X-SEL, not the control port
	 */
	 ...
	 * This will throw an exception if the X-SEL controller believes it is
	 * either holding a source tube, cap, gripping a source tube, or has a 
	 * pipette tip.
