...
INSERT INTO csm_application(APPLICATION_NAME,APPLICATION_DESCRIPTION,DECLARATIVE_FLAG,ACTIVE_FLAG,UPDATE_DATE, DATABASE_URL, DATABASE_USER_NAME, DATABASE_PASSWORD, DATABASE_DIALECT, DATABASE_DRIVER)
VALUES ("biobank2","biobank2",0,0,sysdate(), "jdbc:mysql://localhost:3306/biobank2", "dummy", "4UlzrQJztJY=", "org.hibernate.dialect.MySQLDialect", "com.mysql.jdbc.Driver");
