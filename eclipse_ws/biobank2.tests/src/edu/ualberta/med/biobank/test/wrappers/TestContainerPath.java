...
public class TestContainerPath extends TestDatabase {
    ...
    public void testContainerMoved() throws Exception {
        ...
        c2.setRowColPosition(new RowColPos(1, 1));
        c2.persist();
        c4.reload();

        Assert.assertEquals(p4Before, c4.getPath());

        c3.setRowColPosition(new RowColPos(1, 1));
        c3.persist();
        c3.reload();
        c4.reload();
        Assert.assertEquals(p4Before, c4.getPath());
        ...
        c3.setParent(c1);
        c3.setRowColPosition(new RowColPos(0, 1));
        c1.addChild(0, 1, c3);
        c1.persist();
        c3.persist();
        c3.reload();
        ...
        c4.setParent(c2);
        c4.setRowColPosition(new RowColPos(0, 1));
        c4.persist();
        c4.reload();
