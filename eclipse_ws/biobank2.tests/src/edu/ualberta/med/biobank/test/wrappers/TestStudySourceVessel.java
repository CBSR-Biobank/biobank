...
public class TestStudySourceVessel extends TestDatabase {
    ...
    public void testResetAlreadyInDatabase() throws Exception {
        ...
        ssv1.setNeedReceivedVolume(true);
        ssv1.persist();

        Boolean oldNeedVolume = ssv1.getNeedReceivedVolume();
        ssv1.setNeedReceivedVolume(false);
        ssv1.reset();
        Assert.assertEquals(oldNeedVolume, ssv1.getNeedReceivedVolume());
    }
