...
public class TestDispatch extends TestDatabase {
    ...
    public void testGettersAndSetters() throws Exception {
        ...
        DispatchWrapper shipment =
            DispatchHelper.addShipment(senderSite, receiverSite, study,
    ...
    public void testConstructor() throws Exception {
        ...
        DispatchWrapper shipment =
            new DispatchWrapper(appService, shipmentRaw);
    ...
    public void testGetSetSender() throws Exception {
        ...
        DispatchWrapper shipment =
            DispatchHelper.newShipment(null, receiverSite, study,
                ShippingMethodWrapper.getShippingMethods(appService).get(0));
        ...
        DispatchWrapper shipment2 =
            new DispatchWrapper(appService, shipment.getWrappedObject());
    ...
    public void testGetSetReceiver() throws Exception {
        ...
        DispatchWrapper shipment =
            DispatchHelper.newShipment(senderSite, null, study,
                ShippingMethodWrapper.getShippingMethods(appService).get(0));
    ...
    public void testPersist() throws Exception {
        ...
        DispatchWrapper shipment2 =
            DispatchHelper.newShipment(senderSite, receiverSite, study,
                method, name, Utils.getRandomDate());
        ...
        shipment2 =
            DispatchHelper.newShipment(senderSite2, receiverSite2,
        ...
        // test no receiver
        shipment =
            DispatchHelper.newShipment(senderSite, null, study, method,
        ...
        shipment =
            DispatchHelper.newShipment(senderSite2, receiverSite,
    ...
    public void testGetWrappedClass() throws Exception {
        DispatchWrapper shipment =
            DispatchHelper.newShipment(null, null, null,
                ShippingMethodWrapper.getShippingMethods(appService).get(0));
    ...
    public void testDetlete() throws Exception {
        ...
        int countBefore =
            appService.search(Dispatch.class, new Dispatch())
                .size();
    ...
    public void testGetSetAliquotCollection() throws Exception {
        ...
        ShipmentWrapper shipment =
            ShipmentHelper.addShipment(senderSite, clinic,
                ShippingMethodWrapper.getShippingMethods(appService).get(0),
                patient);
        ...
        dispatch.addNewAliquots(aliquotSet1);
        dispatch.persist();
        dispatch.reload();
        ...
        dispatch.addNewAliquots(aliquotSet2);
        dispatch.persist();
        dispatch.reload();
