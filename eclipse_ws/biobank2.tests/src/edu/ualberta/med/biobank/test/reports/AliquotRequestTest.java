...
public class AliquotRequestTest {
    ...
    private List<Object> getExpectedResults(final Date aliquotDrawnDate) {
        ...
        List<AliquotWrapper> filteredAliquots = new ArrayList<AliquotWrapper>(
            PredicateUtil.filter(allAliquots, PredicateUtil.andPredicate(
                TestReports.aliquotDrawnSameDay(aliquotDrawnDate),
    ...
    private Collection<Object> checkReport(Date aliquotDrawnDate)
        throws ApplicationException {
        return TestReports.getInstance().checkReport(
            getReport(aliquotDrawnDate), getExpectedResults(aliquotDrawnDate),
            true);
    }
