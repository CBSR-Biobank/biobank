...
import edu.ualberta.med.biobank.widgets.nebula.v.VSpacer;
...
class DiscreteTimePicker extends VPanel {
    ...
    protected void createContents() {
        ...
        layout.numColumns = isHorizontal ? (is24Hour ? 12 : 14) : (is24Hour ? 4
            : 3);
    ...
    private void createHorizontal() {
        ...
        for (int i = 0; i < minutes.length; i++) {
            ...
            minutes[i].setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
                true));
