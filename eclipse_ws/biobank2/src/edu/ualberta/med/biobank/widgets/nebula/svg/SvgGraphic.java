...
public abstract class SvgGraphic extends SvgElement {
     ...
     * method is called all transformations and css properties to be calculated
     * and applied. If this is a shape, it will be painted to the graphics
     * context. Containers will recursively make this call on their children.
     * </p>
     * 
    ...
    /**
     * Returns the value of the <code>desc</code> element that is a child of
     * this svg element. If there is no <code>desc</code> element that is a
     * direct decendent of this element, null is returned.
     * 
        ...
        for (SvgElement el : getAncestry(this)) {
            if (el instanceof SvgFragment) {
                ...
                if (!st.isIdentity()) {
                    ...
                    tmp.setElements(st.data[0], st.data[1], st.data[2],
    ...
    /**
     * Returns the value of the <code>title</code> element that is a child of
     * this svg element. If there is no <code>title</code> element that is a
     * direct decendent of this element, null is returned.
     * 
