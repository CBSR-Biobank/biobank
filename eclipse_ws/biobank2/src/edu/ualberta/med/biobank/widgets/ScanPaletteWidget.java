...
public class ScanPaletteWidget extends AbstractGridContainerWidget {
	...
	/**
	 * Palettes are always 8*12 = fixed size
	 */
	...
	protected PaletteCell[][] scannedElements;
	...
	public void setScannedElements(PaletteCell[][] elements) {
		this.scannedElements = elements;
		redraw();
	}

	public PaletteCell[][] getScannedElements() {
		return scannedElements;
	}

	public PaletteCell getCellAtCoordinates(int xPosition, int yPosition) {
		if (scannedElements == null) {
			return null;
		}
