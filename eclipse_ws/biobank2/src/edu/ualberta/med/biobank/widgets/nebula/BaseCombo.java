...
import edu.ualberta.med.biobank.widgets.nebula.v.VSimpleLayout;
...
public abstract class BaseCombo extends Canvas {
        ...
        protected void layout(VPanel panel, boolean flushCache) {
            ...
            if (leftAlign) {
                text.setBounds(cRect.x + bSize.x, cRect.y
                    + (win32 ? getBorderWidth() : 0), cRect.width - bSize.x,
                    tSize.y);
     ...
     * 
     * @param alignment can be either SWT.LEFT or SWT.RIGHT. Other values have
     *            no effect.
     */
