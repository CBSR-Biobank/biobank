...
public class CancelConfirmWidget extends BgcBaseWidget {
    ...
    private void createContents() {
        form.getToolkit().createLabel(this, Messages.CancelConfirmWidget_cancelconfirm_label);
        ...
        cancelButton = form.getToolkit().createButton(this, Messages.CancelConfirmWidget_cancel_label, SWT.PUSH);
        ...
        confirmButton = form.getToolkit().createButton(this, Messages.CancelConfirmWidget_confirm_label,
            SWT.PUSH);
