...
public class SvgDocument extends SvgContainer {
    ...
    /**
     * Apply this svg document to the given graphics context, scaled to fit
     * within the given bounds. This method will recursive call the apply
     * methods of all contained svg elements, thereby painting the entire
     * document to the given graphics context.
     * 
    ...
    /**
     * Returns the SvgFragment element within this document that corresponds to
     * the given id.
     * 
     * @param id
    ...
    /**
     * Returns an array of all the SvgFragment elements contained by this
     * document. This is a new array - modification to it will not affect the
