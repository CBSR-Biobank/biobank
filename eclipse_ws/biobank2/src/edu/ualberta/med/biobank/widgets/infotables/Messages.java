...
public class Messages extends NLS {
    ...
    public static String ClinicInfoTable_patients_label;

    public static String ClinicInfoTable_status_label;

    public static String ClinicInfoTable_study_count_label;

    public static String ClinicInfoTable_visits_label;
    ...
    public static String ClinicVisitInfoTable_source_specs_label;
    ...
    public static String ContactInfoTable_office_label;

    public static String ContactInfoTable_pager_label;

    public static String ContactInfoTable_studies_label;

    public static String ContactInfoTable_title_label;

    public static String ContainerInfoTable_barcode_label;
    ...
    public static String ContainerInfoTable_temperature_label;

    public static String ContainerInfoTable_type_label;
    ...
    public static String ContainerTypeInfoTable_nameshort_label;

    public static String ContainerTypeInfoTable_status_label;

    public static String ContainerTypeInfoTable_temperature_label;
    ...
    public static String SpecimenInfoTable_study_label;

    public static String SpecimenInfoTable_time_drawn_label;
    ...
    public static String StudyInfoTable_nameshort_label;

    public static String StudyInfoTable_patients_label;

    public static String StudyInfoTable_status_label;
    ...
    public static String DispatchInfoTable_time_label;

    public static String DispatchInfoTable_waybill_label;

    public static String DispatchSpecimenListInfoTable_14;

    public static String DispatchSpecimenListInfoTable_15;

    public static String DispatchSpecimenListInfoTable_16;

    public static String DispatchSpecimenListInfoTable_17;

    public static String DispatchSpecimenListInfoTable_comment_label;

    public static String DispatchSpecimenListInfoTable_delete_error_title;
    ...
    public static String DispatchSpecimenListInfoTable_remove_multiple_confirm_msg;

    public static String DispatchSpecimenListInfoTable_remove_one_confirm_msg;

    public static String DispatchSpecimenListInfoTable_status_label;

    public static String DispatchSpecimenListInfoTable_type_label;

    public static String GroupInfoTable_delete_confirm_msg;

    public static String GroupInfoTable_delete_confirm_title;
    ...
    public static String InfoTableWidget_delete_label;

    public static String InfoTableWidget_edit_label;

    public static String InfoTableWidget_pages_label;

    public static String LoggingInfoTable_action_label;

    public static String LoggingInfoTable_date_label;

    public static String LoggingInfoTable_details_label;
    ...
    public static String LoggingInfoTable_site_label;

    public static String LoggingInfoTable_type_label;
    ...
    public static String UserInfoTable_confirm_delete_title;

    public static String UserInfoTable_delete_error_msg;
    ...
    public static String UserInfoTable_load_error_msg;
    ...
    public static String UserInfoTable_unlock_label;
