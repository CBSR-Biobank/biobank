...
public class Messages extends NLS {
    ...
    public static String UserEditDialog_password_new_label;

    public static String UserEditDialog_password_retype_label;

    public static String UserEditDialog_password_retype_new_label;
    ...
    public static String UserEditDialog_title_edit;

    public static String UserEditDialog_user_persist_msg;
