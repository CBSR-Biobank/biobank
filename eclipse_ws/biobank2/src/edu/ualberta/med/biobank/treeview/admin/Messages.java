...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "edu.ualberta.med.biobank.treeview.admin.messages"; //$NON-NLS-1$
    public static String ClinicAdapter_clinic_label;
    public static String ClinicAdapter_delete_confirm_msg;
    public static String ClinicMasterGroup_add_label;
    ...
    public static String ContainerAdapter_move_error_title;
    public static String ContainerAdapter_move_label;
    public static String ContainerAdapter_move_parent_error_msg;
    public static String ContainerAdapter_move_specs_error_title;
    public static String ContainerAdapter_move_specs_label;
    public static String ContainerAdapter_moved_info_msg;
    ...
    public static String ContainerGroup_containers_node_label;
    public static String ContainerGroup_create_error_msg;
    public static String ContainerGroup_create_error_title;
    ...
    public static String SiteClinicGroup_clinics_node_label;
    public static String SiteGroup_add_label;
    public static String SiteGroup_sites_node_label;
    public static String SiteStudyGroup_studies_node_label;
    public static String StudyAdapter_delete_confirm_msg;
    public static String StudyAdapter_study_label;
    public static String StudyMasterGroup_add_label;
    public static String StudyMasterGroup_studies_node_label;
    static {
