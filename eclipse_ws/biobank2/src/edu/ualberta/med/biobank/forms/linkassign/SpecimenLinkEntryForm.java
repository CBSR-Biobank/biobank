...
public class SpecimenLinkEntryForm extends AbstractLinkAssignEntryForm {
        ...
        try {
            ...
            if (specimen != null) {
                BgcPlugin.openAsyncError(
                    ...
                    NLS.bind(Messages.SpecimenLinkEntryForm_inventoryId_exists_error_msg,
                        inventoryIdText.getText()));
                ok = false;
            }
        } catch (Exception e) {
        ...
        for (PalletCell cell : cells.values()) {
            if (PalletCell.hasValue(cell)
                ...
                sb.append(Messages.format(
                    Messages.SpecimenLinkEntryForm_activitylog_specimen_linked, cell
    ...
    private void saveSingleSpecimen(OriginInfoWrapper originInfo)
        ...
        appendLog(Messages.format(
            Messages.SpecimenLinkEntryForm_activitylog_specimen_linked, singleSpecimen
