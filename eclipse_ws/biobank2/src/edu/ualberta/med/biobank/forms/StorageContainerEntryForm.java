...
public class StorageContainerEntryForm extends BiobankEntryForm {
    ...
    private void createStorageTypesSection(Composite client) {
        ...
        if (position.getParentContainer() == null) {
            ...
            storageTypes = position.getParentContainer().getStorageType().getChildStorageTypeCollection();
        }
        ...
        storageTypeComboViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                StorageType storageType = (StorageType) selection.getFirstElement();
    ...
    private void createLocationSection() {
        ...
        if (parentContainer != null) {
            ...
            validator = new IntegerNumber(MSG_INVALID_POSITION,
                FormUtils.createDecorator(dimensionTwoLabel,
                    MSG_INVALID_POSITION), false);
    ...
    protected void saveForm() throws Exception {
        ...
        StorageType storageType = (StorageType) ((StructuredSelection) storageTypeComboViewer.getSelection()).getFirstElement();
