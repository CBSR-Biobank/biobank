	...
	public String getName() {
		...
		if (name != null) {
			if (node instanceof SiteAdapter)
				return "Site " + name;
			else if (node instanceof StudyAdapter)
				return "Study " + name;
			else if (node instanceof ClinicAdapter)
				return "Clinic " + name;
			else if (node instanceof StorageTypeAdapter)
				return "Storage Type " + name;
			else if (node instanceof PatientAdapter)
				return "Patient " + name;
			else if (node instanceof PatientVisitAdapter)
