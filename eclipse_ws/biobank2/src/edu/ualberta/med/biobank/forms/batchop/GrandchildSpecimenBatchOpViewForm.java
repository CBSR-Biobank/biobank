...
public class GrandchildSpecimenBatchOpViewForm extends BatchOpViewForm {

    private static final I18n i18n = I18nFactory.getI18n(BatchOpViewForm.class);

    @SuppressWarnings("nls")
    public static final String ID = "edu.ualberta.med.biobank.forms.GrandchildSpecimenBatchOpViewForm";
    ...
    public GrandchildSpecimenBatchOpViewForm() {
        super(FORM_TITLE);
    }
    ...
    protected void init() throws Exception {
        ...
        result = SessionManager.getAppService().
            doAction(new SpecimenBatchOpGetAction(getBatchId()));
