...
public class DispatchSendingEntryForm extends AbstractDispatchEntryForm {
    ...
    protected void saveForm() throws Exception {
        SetDifference<DispatchSpecimenWrapper> diff = new SetDifference<DispatchSpecimenWrapper>(ModelWrapper.wrapModelCollection(SessionManager.getAppService(), dispatchInfo.specimens, DispatchSpecimenWrapper.class), specimensNonProcessedTable.getList());
        List<Integer> addedSpecimenIds = WrapperUtil.getCollectionIds(diff.getAddSet());
        List<Integer> removedSpecimenIds = WrapperUtil.getCollectionIds(diff.getRemoveSet());
        ...
        DispatchSaveInfo dInfo = new DispatchSaveInfo(dispatch.getId(), dispatch.getReceiverCenter().getId(), dispatch.getSenderCenter().getId(), dispatch.getState(), addedSpecimenIds, removedSpecimenIds);
