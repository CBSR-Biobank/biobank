...
public class ContainerViewForm extends BiobankViewForm {
    ...
    private void createContainerSection() {
        ...
        commentsLabel = (Label) createWidget(client, Label.class, SWT.NONE,
            "Comments");
        containerTypeLabel = (Label) createWidget(client, Label.class, SWT.NONE,
            "Container Type");
    ...
    private void setContainerValues() {
        ...
        FormUtils.setTextValue(containerTypeLabel, container
            .getContainerType().getName());
        FormUtils.setTextValue(temperatureLabel, container
            .getTemperature());
