...
public class ShipmentAdministrationView extends
    ...
    protected List<? extends ModelWrapper<?>> search(String text)
        ...
        if (radioWaybill.getSelection()) {
            ...
            if (date != null) {
                returnCollectionEventWrapper.getShipmentsInSites(
    ...
    public static AdapterBase addToNode(AdapterBase parentNode,
        ...
        if (currentInstance != null && wrapper instanceofCollectionEventWrapper) {
    ...
    protected void notFound(String text) {
        if (radioWaybill.getSelection()) {
            ...
            if (create) {
               CollectionEventWrapper shipment = newCollectionEventWrapper(
    ...
    public static void showShipmentCollectionEventWrapper shipment) {
