...
public class AliquotInvoiceByPatientImpl extends AbstractReport {
    ...
    private static String QUERY = "Select Alias.inventoryId, Alias.patientVisit.shipmentPatient.patient.pnumber, Alias.patientVisit.shipmentPatient.shipment.clinic.name,  Alias.linkDate, Alias.sampleType.name from "
