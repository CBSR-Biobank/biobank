...
public class CbsrContainerTypes extends ConfigContainerTypes {
    ...
    private void createFreezerTypes(SiteWrapper site) throws Exception {
        ...
        ContainerTypeWrapper hotel19 = addContainerType(
            site,
            "Hotel 19",
            "H19",
            null,
    ...
    private void createCabinetTypes(SiteWrapper site) throws Exception {
        ...
        ContainerTypeWrapper drawer36 = addContainerType(
            site,
            "Drawer 36",
            "D36",
            null,
            ...
            36,
            1,
            Arrays.asList(new ContainerTypeWrapper[] { ftaBin, ftaBinLoersch,
                hairBin }));
        addContainerType(site, "Cabinet 4 drawer", "Cabinet 4", null,
            ActivityStatusWrapper.ACTIVE_STATUS_STRING, true, 2, 4, 1,
    ...
    private void createDewarTypes(SiteWrapper site) throws Exception {
        ...
        addContainerType(
            ...
            2,
            2,
            Arrays.asList(new ContainerTypeWrapper[] { dewarAA, dewarBB,
                dewarCC, dewarDD }));
    }
}
