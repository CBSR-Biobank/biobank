...
public class VarCharLengths {
    ...
    static {
       Map<String, Integer>  aMap = new HashMap<String, Integer>();
		...
		aMap.put("edu.ualberta.med.biobank.model.AbstractPosition.positionString", 50);
		aMap.put("edu.ualberta.med.biobank.model.ContainerPosition.positionString", 50);
		aMap.put("edu.ualberta.med.biobank.model.PropertyType.name", 255);
		aMap.put("edu.ualberta.med.biobank.model.ContainerLabelingScheme.name", 50);
		...
		aMap.put("edu.ualberta.med.biobank.model.BbGroup.name", 255);
		...
		aMap.put("edu.ualberta.med.biobank.model.SpecimenPosition.positionString", 50);
		...
		aMap.put("edu.ualberta.med.biobank.model.PrinterLabelTemplate.printerName", 50);
		...
		aMap.put("edu.ualberta.med.biobank.model.ProcessingEvent.worksheet", 100);
