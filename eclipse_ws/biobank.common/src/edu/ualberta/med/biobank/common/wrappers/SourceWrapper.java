...
public class SourceWrapper extends AbstractShipmentWrapper<Source> {
     ...
     */
    public static List<SourceWrapper> getShipmentsInSites(
        ...
        List<SourceWrapper> wrappers = new ArrayList<SourceWrapper>();
        for (Shipment s : shipments) {
            wrappers.add(new SourceWrapper(appService, s));
        }
        return wrappers;
    }
    ...
    public static List<SourceWrapper> getTodayShipments(
        ...
        List<SourceWrapper> ships = new ArrayList<SourceWrapper>();
        for (Shipment s : res) {
            ships.add(new SourceWrapper(appService, s));
        }
        return ships;
    }
