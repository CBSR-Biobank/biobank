...
public enum FilterOperator {
    ...
    LESS_THAN_OR_EQUAL_TO(202, false, true),
    GREATER_THAN(203, false, true),
    GREATER_THAN_OR_EQUAL_TO(204, false, true),

    // Date operators
    ON_OR_BEFORE(301, false, true),
    ON_OR_AFTER(302, false, true),

    THIS_DAY(321, false, false),
    THIS_WEEK(322, false, false),
