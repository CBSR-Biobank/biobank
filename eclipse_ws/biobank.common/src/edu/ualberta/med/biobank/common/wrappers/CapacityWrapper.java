...
public class CapacityWrapper extends ModelWrapper<Capacity> implements
    Comparable<CapacityWrapper> {
    ...
    @Override
    public int compareTo(CapacityWrapper cap) {
        Integer rowCapacity1 = getRowCapacity();
        Integer rowCapacity2 = cap.getRowCapacity();
        int compare = rowCapacity1.compareTo(rowCapacity2);
        if (compare == 0) {
            Integer colCapacity1 = getColCapacity();
            Integer colCapacity2 = cap.getColCapacity();
