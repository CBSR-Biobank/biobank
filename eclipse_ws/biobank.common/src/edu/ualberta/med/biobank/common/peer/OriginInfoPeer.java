...
public class OriginInfoPeer {
    public static final Property<Integer, OriginInfo> ID = Property.create("id" //$NON-NLS-1$
        , OriginInfo.class
        , new TypeReference<Integer>() {
        }
        , new Property.Accessor<Integer, OriginInfo>() {
    ...
    public static final Property<Center, OriginInfo> CENTER = Property.create(
        ...
        , new Property.Accessor<Center, OriginInfo>() {
            private static final long serialVersionUID = 1L;
    ...
    public static final Property<ShipmentInfo, OriginInfo> SHIPMENT_INFO =
        Property.create("shipmentInfo" //$NON-NLS-1$
            , OriginInfo.class
            , new TypeReference<ShipmentInfo>() {
            }
            , new Property.Accessor<ShipmentInfo, OriginInfo>() {
                private static final long serialVersionUID = 1L;
    ...
    public static final Property<Collection<Comment>, OriginInfo> COMMENTS =
        Property.create("comments" //$NON-NLS-1$
            , OriginInfo.class
            , new TypeReference<Collection<Comment>>() {
            }
            , new Property.Accessor<Collection<Comment>, OriginInfo>() {
                private static final long serialVersionUID = 1L;
    ...
    public static final Property<Center, OriginInfo> RECEIVER_CENTER = Property
        .create("receiverCenter" //$NON-NLS-1$
            , OriginInfo.class
            , new TypeReference<Center>() {
            }
            , new Property.Accessor<Center, OriginInfo>() {
    ...
    public static final Property<Collection<Specimen>, OriginInfo> SPECIMENS =
        Property.create("specimens" //$NON-NLS-1$
            , OriginInfo.class
            , new TypeReference<Collection<Specimen>>() {
            }
            , new Property.Accessor<Collection<Specimen>, OriginInfo>() {
                private static final long serialVersionUID = 1L;
    ...
    static {
        List<Property<?, ? super OriginInfo>> aList =
            new ArrayList<Property<?, ? super OriginInfo>>();
        aList.add(ID);
        aList.add(CENTER);
