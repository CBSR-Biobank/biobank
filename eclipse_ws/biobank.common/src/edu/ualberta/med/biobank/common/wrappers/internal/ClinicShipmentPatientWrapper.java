...
public class ClinicShipmentPatientWrapper extends
    ...
    public ClinicShipmentWrapper getShipment() {
        if (!propertiesMap.containsKey(PROP_KEY_SHIPMENT)) {
            ...
            if (rawShipment != null) {
                wrappedShipment = new ClinicShipmentWrapper(appService,
                    rawShipment);
            }
    ...
    public static Collection<ClinicShipmentPatientWrapper> wrapClinicShipmentPatientCollection(
        ...
        Collection<ClinicShipmentPatientWrapper> wrappedCsps = new ArrayList<ClinicShipmentPatientWrapper>();
        for (ClinicShipmentPatient csp : rawCsps) {
            ClinicShipmentPatientWrapper wrappedCsp = new ClinicShipmentPatientWrapper(
                appService, csp);
