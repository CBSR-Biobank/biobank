...
public class VControlPainter implements IControlPainter {
    ...
    private static void paintImage(VControl control, Event e) {
        ...
        if (control.scaleImage) {
            ...
            e.gc.drawImage(control.image, 0, 0, ibounds.width, ibounds.height,
                cbounds.x, cbounds.y, cbounds.width, cbounds.height);
        } else {
            e.gc.drawImage(control.image, (int) getX(control, ibounds.width),
                (int) getY(control, ibounds.height));
        }
    }
    ...
    private static void paintPoly(VControl control, Event e, int x, int y,
        int minX, int minY) {
