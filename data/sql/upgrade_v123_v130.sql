...
CREATE TABLE abstract_container (
    ...
    ACTIVITY_STATUS_ID int(11) NOT NULL COMMENT '',
    CONTAINER_TYPE_ID int(11) NOT NULL COMMENT '',
...
INSERT INTO abstract_container (ID, DISCRIMINATOR, PRODUCT_BARCODE,
COMMENT,ACTIVITY_STATUS_ID, CONTAINER_TYPE_ID, LABEL, TEMPERATURE,
POSITION_ID, SITE_ID)
SELECT ID, 'Container', PRODUCT_BARCODE, COMMENT, ACTIVITY_STATUS_ID,
CONTAINER_TYPE_ID, LABEL, TEMPERATURE, POSITION_ID, SITE_ID
FROM container;
...
ALTER TABLE abstract_position
      ADD COLUMN DISCRIMINATOR VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL AFTER ID,
