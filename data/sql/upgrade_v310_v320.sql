...
INSERT INTO container_position (ABS_ID, VERSION, `ROW`, COL, POSITION_STRING, PARENT_CONTAINER_ID)
       SELECT ID, 0, `ROW`, COL, POSITION_STRING, PARENT_CONTAINER_ID FROM abstract_position
