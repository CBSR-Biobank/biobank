...
ALTER TABLE container DROP FOREIGN KEY FK8D995C61AC528270;
...
ALTER TABLE container MODIFY COLUMN PATH VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL;
...
ALTER TABLE container ADD CONSTRAINT FK8D995C61AC528270 FOREIGN KEY FK8D995C61AC528270 (POSITION_ID) REFERENCES container_position (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
