create table ANNOTATION_OPTION (
    ...
    alter table CONTAINER 
        add constraint key2 unique (CONTAINER_TREE_ID, LABEL)

    alter table CONTAINER 
        add constraint key3 unique (PARENT_CONTAINER_ID, CONTAINER_SCHEMA_POSITION_ID)
    ...
    alter table Group 
        add constraint FK41E065F53BDE4C6 
        foreign key (ID) 
        references PRINCIPAL

    alter table Group_AUD 
        add constraint FK1F11ECB0C91FDBA 
        foreign key (ID, REV) 
