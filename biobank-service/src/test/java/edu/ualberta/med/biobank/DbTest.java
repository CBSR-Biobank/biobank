...
import edu.ualberta.med.biobank.model.HibernateConfig;
...
public class DbTest 
	 ...
	 * 
	 * @param klazz
	 *            the type of entity to insert and update
	 * @param processor
	 *            run on the entity instance to "make it wrong"
	 * @param assertion
	 *            describes the expected ConstraintViolationException
	 */
