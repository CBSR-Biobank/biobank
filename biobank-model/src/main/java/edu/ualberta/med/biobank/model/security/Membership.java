...
public abstract class Membership<T extends Permission, U extends Role<T>>
    ...
    /**
     * @return true if the {@link Principal} has all associated permissions and
     *         is able to create, edit, or remove other user memberships with
     *         the same owner (e.g. {@link Center} or {@link Study}), otherwise
     *         false.
     */
