...
\missingfigure{individual patient label}
...
\begin{figure}[H]
  \centering
  \scalebox{0.45}
	   { \includegraphics*{screenshots/printer_labels/05_label_templates_form} }
...
and pressing the \fbox{Delete} button.
...
\ref{fig:label_templates_form}, then the patient barcode is printed at position
XX from the top left corner of the first label.

\missingfigure{General Barcode}
\missingfigure{Barcode 1}
