...
\begin{description}
  ...
  \item[Status Messages] The status message are is used to display various
    status messages by the application. These messages show the current state
    of the application.
\end{description}
